...
org_config_file = script_path + '/config/new-cdn-urls.json'
...
if selected_method == "Adapt1":
	...
	updated_adapt_cdn = collaborative_cdn(adapt_cdn, video_name, selected_method)
	...
	adapt_cdn = {}
	adapt_cdn['Azure'] = cdns['Azure'].copy()
	adapt_cdn['Google'] = cdns['Google'].copy()
	updated_adapt_cdn = collaborative_cdn(adapt_cdn, video_name, selected_method)
	cdns['Azure'] = updated_adapt_cdn['Azure'].copy()
	cdns['Google'] = updated_adapt_cdn['Google'].copy()
